...
export const metadata: Metadata = {
  ...
  description: "Decode Indian Railway jargon. Learn the exact meanings of RLWL, PQWL, GNWL, RAC, Tatkal, Vikalp, Chart Preparation, and other IRCTC booking terms.",
  alternates: {
    canonical: "/glossary",
  },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-12 text-center">
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
          Indian Railway Glossary
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
          The ultimate dictionary for decoding IRCTC booking codes, waiting list types, and railway terminology.
        </p>
      </div>
      ...
      <div className="space-y-12">
        {Object.keys(grouped).sort().map((letter) => (
          <section key={letter} className="relative">
            <h2 className="sticky top-0 bg-white/90 py-2 text-2xl font-bold text-blue-600 backdrop-blur z-10 border-b border-slate-200">
              {letter}
            </h2>
