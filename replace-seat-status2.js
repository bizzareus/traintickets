const fs = require('fs');
const path = 'components/booking-v2/SeatStatus.tsx';
...
// Replace lines 384 to 733
lines.splice(384, 350, newCode);

let updated = lines.join('\n');

// Replace the CoachMap invocation
...
// Remove the "Click any berth" text
updated = updated.replace(
