...
- **Seat Status Coach Journey Lookup:** Want to see if there are vacant berths on a running train? Use our **[Coach Journey Lookup](/seat-status)** to see exactly from which station to which station specific seats are booked. This helps you identify empty berths post-chart preparation so you can request the TTE to allocate them to you.
