...
1. **Try Self-Verification:** Log in to the IRCTC portal and look for any prompts to complete mobile or email OTP verification.
2. **Email IRCTC Customer Support:** Send an email to `care@irctc.co.in` or `etickets@irctc.co.in` from your registered email address.
3. **Provide Identity Details:** Clearly state your IRCTC User ID and registered mobile number, and attach a scanned copy of a valid government ID (such as Aadhaar card, PAN card, or Voter ID) as proof of personal identity.
4. **Wait for Support Validation:** Allow the support team to validate your details. This process usually takes 2 to 5 business days.
5. **Create a New ID if Permanently Banned:** If IRCTC banned you under Section 143 for commercial bookings, they won't unblock it. You'll need to sign up with a new mobile number and email ID.
...
## Related Guides
- [IRCTC Monthly Ticket Limits: Aadhaar Link & Verification](/blog/irctc-ticket-booking-limits-aadhaar-verification)
- [Rules for Booking Train Tickets on Personal IDs (Section 143)](/blog/irctc-personal-id-booking-rules-section-143)
- [IRCTC Login & Booking Timings: Tatkal & Maintenance Windows](/blog/irctc-booking-timings-rules)
