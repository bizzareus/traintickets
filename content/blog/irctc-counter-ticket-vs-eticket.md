...
1. Visit the official IRCTC website and navigate to the **Counter Ticket Cancellation** page.
2. Enter your **PNR Number**, **Ticket Number**, and the captcha code.
3. Check the terms and conditions box and click **Submit**.
4. An OTP will be sent to the mobile number you provided during booking.
5. Enter the OTP and click **Submit** to confirm the cancellation.
6. The screen will show the cancellation details and the refund amount due.
7. Visit a railway counter with your original physical ticket to collect your cash refund.
