...
tags:
  ...
  - यात्रा गाइड
---
> **बिना कंफर्म टिकट यात्रा के जुर्माने से बचें:** बोर्डिंग से पहले अपना टिकट स्टेटस चेक करने के लिए [Smart Seats](/) और खाली बर्थ की जानकारी पाने के लिए [Get Confirmed Tickets](/) का उपयोग करें।
...
यदि आपकी टिकट वेटलिस्टेड है और आप बिना पुष्टि की गई ई-टिकट पर चढ़ने के बारे में चिंतित हैं (जो अवैध है और नए नियमों के तहत ₹500 का जुर्माना है), तो आप अपनी स्थिति की जांच कर सकते हैं [PNR Status Search](/) पर या [Get Confirmed Tickets](/) का उपयोग कर सकते हैं यह देखने के लिए कि यात्रा के विशिष्ट चरणों पर कौन सी बर्थें खाली हैं। यह आपको टीटीई के साथ कानूनी रूप से समन्वय करने में मदद करता है न कि अवैध कोचों में चढ़ने में।
...
यह सुनिश्चित करने के लिए कि आप कभी भी इन जुर्मानों का सामना न करें, सुनिश्चित करें कि आप हमेशा एक वैध टिकट बुक करें। यदि सीधे ट्रेनों में वेटिंग लिस्ट दिखाई देती है, तो LastBerth पर [Finding Smart Seats](/) उपकरण का उपयोग करें अपनी यात्रा को पुष्टि की गई सीटों में विभाजित करने के लिए, या [Get Confirmed Tickets](/) पर जांचें कि कौन सी बर्थें खाली हैं। चढ़ने से पहले हमेशा अपनी स्थिति की पुष्टि करें आधिकारिक IRCTC वेबसाइट या ऐप पर।
