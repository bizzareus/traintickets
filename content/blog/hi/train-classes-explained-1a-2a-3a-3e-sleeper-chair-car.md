---
title: "ट्रेन क्लास कोड 2026: 1A, 2A, 3A, 3E, SL व CC में अंतर और किराया"
description: "1A, 2A, 3A, 3E, Sleeper, Chair Car और 2S में क्या अंतर है? किराया, बेडरोल, लेआउट और कौन सी क्लास बुक करें, जानें 2026 गाइड।"
date: "2026-07-06"
updated: "2026-07-31"
tags:
  - train booking
...
> **क्लास चुन ली? अब उसमें सीट ढूंढें:** किसी भी रूट को [Smart Seats](/) पर सर्च करें और 1A, 2A, 3A, SL और Chair Car में लाइव उपलब्धता की तुलना करें — और [Coach Journey Lookup](/seat-status) देखें कि चार्ट बनने के बाद किन क्लास में अब भी खाली बर्थ बची हैं।
...
भारत में सबसे लोकप्रिय AC क्लास। स्लीपर जैसी ही 8-बर्थ बे (दोनों तरफ लोअर, मिडिल, अपर, साथ में साइड लोअर और साइड अपर), पर एयर-कंडीशंड, पर्दों वाली, लोअर बर्थ के पास चार्जिंग पॉइंट के साथ। हर कोच में 64–72 बर्थ। मुफ्त बिस्तर शामिल। अगर आप 2A के दाम चुकाए बिना AC चाहते हैं, तो यह डिफ़ॉल्ट पसंद है। पक्का नहीं कि लोअर, मिडिल, अपर या साइड बर्थ में से कौन सी चुनें? [ट्रेन बर्थ टाइप्स गाइड](/blog/train-berth-types-availability-reservation-guide) हर बर्थ के आराम, प्राइवेसी और सामान रखने की सुविधा की तुलना करता है।
...
- **Available / "current available ticket":** एक पूरी तरह कन्फर्म सीट जिसमें कोच और बर्थ तय हो चुकी है। यह स्टेटस चार्ट तैयार होने के बाद, प्रस्थान से लगभग 8 घंटे पहले खुलता है और प्रस्थान से लगभग 30 मिनट पहले बंद हो जाता है।
...
**यह संक्षिप्त नाम भारतीय रेलवे टिकटों पर बर्थ स्थिति कोड दर्शाते हैं: LB का मतलब लोअर बर्थ (Lower Berth), MB का मतलब मिडिल बर्थ (Middle Berth), UB का मतलब अपर बर्थ (Upper Berth), SL का मतलब साइड लोअर (Side Lower), SU का मतलब साइड अपर (Side Upper) और SM का मतलब 3E इकॉनमी कोच में साइड मिडिल बर्थ (Side Middle Berth) है।**

इन कोड्स को समझने से आपको ट्रेन में चढ़ते ही अपनी बैठने व सोने की सही जगह ढूंढने में मदद मिलती है:
- **LB (लोअर बर्थ):** ज़मीन के स्तर वाली बंक, वरिष्ठ नागरिकों और परिवारों के लिए सबसे आसान।
- **MB (मिडिल बर्थ):** लोअर और अपर के बीच में मुड़ने वाली बर्थ; दिन के समय बंद रहती है।
- **UB (अपर बर्थ):** सबसे ऊपर वाली बर्थ जिसमें सबसे ज़्यादा निजता मिलती है, सीढ़ी से चढ़ना होता है।
- **SL व SU (साइड बर्थ):** गलियारे की तरफ वाली बर्थ; SL दिन में दो सीटों में बदल जाती है।
- **SM (साइड मिडिल):** केवल 83-बर्थ वाले 3E (AC 3-टियर इकॉनमी) कोचों में मिलती है।
...
## 3A और 3E इकॉनमी कोच में क्या अंतर है?

3E (AC 3-टियर इकॉनमी) कोच में 83 बर्थ होती हैं जिनमें संकरी मिडिल बर्थ और हर बे के लिए अलग AC वेंट होते हैं, जबकि मानक 3A कोच में 72 बर्थ चौड़ी सीटों और मानक लेआउट के साथ होती हैं। 3E को कम लागत वाला AC विकल्प प्रदान करने के लिए पेश किया गया था, जो बर्थ की चौड़ाई घटाकर और एक साइड-मिडिल बर्थ जोड़कर कोच की क्षमता बढ़ाता है।

---

## किन ट्रेन क्लास में मुफ्त खाना और बेडरोल की सुविधा शामिल होती है?

बेडरोल 1A, 2A, 3A और 3E AC क्लास (गरीब रथ को छोड़कर) में मुफ्त मिलते हैं, और राजधानी, शताब्दी, दुरंतो व वंदे भारत ट्रेनों में कैटरिंग (खाना) पहले से शामिल होता है (जब तक कि आपने ऑप-आउट न किया हो)। स्लीपर (SL) और सेकंड सिटिंग (2S) जैसी नॉन-AC क्लास में मुफ्त बेडरोल या मुफ्त खाना नहीं मिलता है।
...
### क्या स्लीपर क्लास के टिकट से AC 3-टियर में यात्रा की जा सकती है?

नहीं, निचले क्लास के टिकट पर उच्च क्लास में यात्रा करना रेलवे अधिनियम की धारा 138 (Section 138 of the Railways Act) के तहत अपराध है, जिसके लिए किराए का अंतर और जुर्माना दोनों देना पड़ता है।

### सेकंड सिटिंग (2S) क्या है और यह स्लीपर (SL) से कैसे अलग है?

2S बिना लेटने की जगह (बर्थ) के रिज़र्व्ड नॉन-AC गद्देदार बैठने की सीटें प्रदान करता है, जबकि स्लीपर (SL) रात भर के सफर के लिए 3-टियर लेटने की बर्थ प्रदान करता है।
