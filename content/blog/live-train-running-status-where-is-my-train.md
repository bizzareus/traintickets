...
| What you want | SMS format | Send to |
|---|---|---|
| Live running status | `SPOT <train no.>` | 139 |
| PNR status | `PNR <10-digit PNR>` | 139 |
| Seat availability | `AVL <train no.> <date> <class> <quota>` | 139 |
| Fare enquiry | `FARE <train no.> <from> <to> <class>` | 139 |
