...
1.  **Ticket Verification:** Checking the validity of tickets and matching passenger names with their ID proofs.
2.  **Identity Verification:** Ensuring passengers carry acceptable physical or digital IDs (like mAadhaar or DigiLocker).
3.  **Penalty Collection:** Penalizing ticketless passengers, those traveling in the wrong class, or those with unconfirmed waitlisted e-tickets.
4.  **Passenger Assistance:** Helping passengers locate their coaches, resolving seating disputes, and coordinating with train guards or security forces (GRP/RPF) in case of emergencies.
