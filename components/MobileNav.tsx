  ...
  return (
    <div className="md:hidden">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((o) => !o)}
        className="flex h-10 w-10 items-center justify-center rounded-lg text-slate-700 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/30 touch-manipulation"
      >
        {open ? (
