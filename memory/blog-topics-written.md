# Blog Topics Written — LastBerth

This file tracks all blog posts published to avoid duplication.

## Posts as of 2026-05-29

| Filename | Topic | Date |
|---|---|---|
| rac-vs-wl-explained.md | RAC vs WL vs Confirmed status definitions | 2026-05-15 |
| segment-booking-confirmed-tickets.md | Segment booking method — splitting journey into station pairs | 2026-05-15 |
| confirmed-from-origin-segment-booking.md | Why first confirmed leg from origin is critical in segment booking | 2026-05-15 |
| best-train-when-all-trains-show-waiting-list.md | Ranking trains when all show WL/RAC/Regret | 2026-05-15 |
| irctc-chart-preparation-guide.md | What chart preparation is, when it happens, how to use it | 2026-05-15 |
| how-to-check-vacant-berths-after-chart-preparation.md | Finding and using vacant berths after chart is prepared | 2026-05-15 |
| boarding-station-vs-remote-location-irctc-chart.md | Boarding station vs remote location in IRCTC charts | 2026-05-15 |
| change-class-confirmed-train-ticket.md | Switching class (SL/3A/2A) to get a confirmed ticket | 2026-05-18 |
| tatkal-vs-current-availability-last-minute-train-ticket.md | Tatkal quota vs Current Availability — when to use each | 2026-05-27 |
